...
// ── Sub-categories under Computer Parts (parent_id = 4) ──────
$subs_result = mysqli_query($conn,
    "SELECT category_id, category_name FROM categories
     WHERE parent_category_id = 4 AND is_visible = 1
...
$brands_result = $sub_ids_str_for_brands ? mysqli_query($conn,
...
// ── Current sub name ──────────────────────────────────────────
$current_sub_name = 'All Computer Parts';
if ($sub_id > 0) {
...
<div class="listing-page">
    ...
    <aside class="listing-sidebar">
        ...
        <div class="sidebar-section">
            <h3 class="sidebar-title">Component Type</h3>
            <ul class="sidebar-links">
                ...
                <li>
                    <a href="computer-parts.php?sub=<?php
                        echo $s['category_id'];
                        echo $brand_filter ? '&brand=' . urlencode($brand_filter) : '';
                        echo $sort !== 'name_asc' ? '&sort=' . $sort : '';
                    ?>" class="<?php echo $sub_id === (int)$s['category_id'] ? 'sidebar-active' : ''; ?>">
        ...
        <div class="sidebar-section">
            ...
            <ul class="sidebar-links">
                <li>
                    <a href="computer-parts.php?<?php echo $sub_id ? 'sub='.$sub_id.'&' : ''; ?>sort=<?php echo $sort; ?>"
                       class="<?php echo $brand_filter === '' ? 'sidebar-active' : ''; ?>">
                        All Brands
                    </a>
                </li>
                <?php if ($brands_result): while ($b = mysqli_fetch_assoc($brands_result)): ?>
                <li>
                    <a href="computer-parts.php?<?php echo $sub_id ? 'sub='.$sub_id.'&' : ''; ?>brand=<?php echo urlencode($b['brand']); ?>&sort=<?php echo $sort; ?>"
        ...
        <div class="sidebar-section">
            ...
            <form method="GET" action="computer-parts.php" class="sidebar-price-form">
                <?php if ($sub_id): ?>
                    <input type="hidden" name="sub" value="<?php echo $sub_id; ?>">
                <?php endif; ?>
                <?php if ($brand_filter): ?>
                ...
                <?php if ($min_price > 0 || $max_price < 999999): ?>
                    <a href="computer-parts.php?<?php
                        echo $sub_id    ? 'sub='.$sub_id.'&'               : '';
                        echo $brand_filter ? 'brand='.urlencode($brand_filter).'&' : '';
                    ?>sort=<?php echo $sort; ?>" class="sidebar-clear-link">Clear price</a>
                <?php endif; ?>
            </form>
        </div>
    ...
    <main class="listing-main">
        ...
        <div class="listing-breadcrumb">
            ...
            <a href="computer-parts.php">Computer Parts</a>
            <?php if ($sub_id > 0): ?>
                › <span><?php echo htmlspecialchars($current_sub_name); ?></span>
            <?php endif; ?>
        </div>
        ...
        <div class="listing-topbar">
            ...
            <form method="GET" action="computer-parts.php" class="sort-form">
                <?php if ($sub_id): ?>
                    <input type="hidden" name="sub" value="<?php echo $sub_id; ?>">
                <?php endif; ?>
                <?php if ($brand_filter): ?>
        ...
        <div class="active-filters">
            ...
            <?php if ($brand_filter): ?>
                <span class="filter-tag">
                    ...
                    <a href="computer-parts.php?<?php echo $sub_id ? 'sub='.$sub_id.'&' : ''; ?>sort=<?php echo $sort; ?>">✕</a>
                </span>
            <?php endif; ?>
            <?php if ($min_price > 0 || $max_price < 999999): ?>
                <span class="filter-tag">
        ...
        <div class="listing-empty">
            ...
            <p class="empty-sub">
                ...
                <a href="computer-parts.php">clear all filters</a>.
            </p>
        </div>
        <?php endif; ?>
