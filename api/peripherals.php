<?php
/**
 * PART 4 — REFACTORED PERIPHERALS PAGE
 * FILE: peripherals.php  (REPLACE your existing peripherals.php entirely)
 */
session_start();
include 'db.php';
...
// ── Sub-categories under Peripherals (parent_id = 2) ─────────
$subs_result = mysqli_query($conn,
    "SELECT category_id, category_name FROM categories
     WHERE parent_category_id = 2 AND is_visible = 1
...
// ── Current sub name ──────────────────────────────────────────
$current_sub_name = 'All Peripherals';
if ($sub_id > 0) {
...
<div class="listing-page">
    ...
    <aside class="listing-sidebar">
        ...
        <div class="sidebar-section">
            ...
            <ul class="sidebar-links">
                ...
                <li>
                    <a href="peripherals.php?sub=<?php echo $s['category_id'];
        ...
        <div class="sidebar-section">
            ...
            <ul class="sidebar-links">
                <li>
                    <a href="peripherals.php?<?php echo $sub_id ? 'sub='.$sub_id.'&' : ''; ?>sort=<?php echo $sort; ?>"
                       class="<?php echo $brand_filter === '' ? 'sidebar-active' : ''; ?>">All Brands</a>
                </li>
                <?php while ($b = mysqli_fetch_assoc($brands_result)): ?>
                <li>
                    <a href="peripherals.php?<?php echo $sub_id ? 'sub='.$sub_id.'&' : ''; ?>brand=<?php echo urlencode($b['brand']); ?>&sort=<?php echo $sort; ?>"
        ...
        <div class="sidebar-section">
            ...
            <form method="GET" action="peripherals.php" class="sidebar-price-form">
                ...
                <?php if ($min_price > 0 || $max_price < 999999): ?>
                    <a href="peripherals.php?<?php echo $sub_id ? 'sub='.$sub_id.'&' : ''; ?><?php echo $brand_filter ? 'brand='.urlencode($brand_filter).'&' : ''; ?>sort=<?php echo $sort; ?>"
    ...
    <main class="listing-main">
        ...
        <div class="listing-topbar">
            ...
            <form method="GET" action="peripherals.php" class="sort-form">
                <?php if ($sub_id): ?><input type="hidden" name="sub" value="<?php echo $sub_id; ?>"><?php endif; ?>
                <?php if ($brand_filter): ?><input type="hidden" name="brand" value="<?php echo htmlspecialchars($brand_filter); ?>"><?php endif; ?>
        ...
        <div class="active-filters">
            ...
            <?php if ($brand_filter): ?>
                <span class="filter-tag">Brand: <?php echo htmlspecialchars($brand_filter); ?>
                    <a href="peripherals.php?<?php echo $sub_id ? 'sub='.$sub_id.'&' : ''; ?>sort=<?php echo $sort; ?>">✕</a>
                </span>
            <?php endif; ?>
            <?php if ($min_price > 0 || $max_price < 999999): ?>
                <span class="filter-tag">Price: ₱<?php echo number_format($min_price); ?> – <?php echo $max_price < 999999 ? '₱'.number_format($max_price) : 'Any'; ?>
                    <a href="peripherals.php?<?php echo $sub_id ? 'sub='.$sub_id.'&' : ''; ?><?php echo $brand_filter ? 'brand='.urlencode($brand_filter).'&' : ''; ?>sort=<?php echo $sort; ?>">✕</a>
                </span>
            <?php endif; ?>
        </div>
        <?php endif; ?>
        ...
        <div class="listing-empty">
            ...
            <p class="empty-sub">Try adjusting your filters or <a href="peripherals.php">clear all filters</a>.</p>
        </div>
        <?php endif; ?>
